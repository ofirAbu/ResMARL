...
class HarvestPerturbations_50_EnvWithMessagesGlobal(MapEnvWithMessagesAndGlobalRewardPrediction):
    def __init__(
            self,
        ...
        self.perturbations_magnitude = 50
    ...
    def custom_map_update(self):
        ...
        if not self.time_step_in_instance % self.perturbations_frequency:
            # apply walls and apples perturbations
            # TODO - remove previously added walls
            # TODO - remove some of existing apples
            # TODO - reduce amount of new apples
