...
from config.constants import CLEANUP_BASE_ACTION_SPACE_SIZE, REWARD_UPPER_BOUND
...
# cleanup with mandatory conf properties

class CleanupEnvWithMessagesMandatory(MapEnvWithMandatoryMessages):
    def __init__(
            self,
...
# cleanup with global conf properties

class CleanupEnvWithMessagesGlobal(MapEnvWithMessagesAndGlobalRewardPrediction):
    def __init__(
            self,
            ascii_map=CLEANUP_MAP,
            num_agents=1,
