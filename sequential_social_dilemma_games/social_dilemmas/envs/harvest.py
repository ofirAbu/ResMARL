...
# harvest with mandatory, no perts

class HarvestEnvWithMessagesMandatory(MapEnvWithMandatoryMessages):
    def __init__(
            self,
...
class HarvestEnvWithMessagesGlobal(MapEnvWithMessagesAndGlobalRewardPrediction):
    def __init__(
            self,
            ascii_map=HARVEST_MAP,
            num_agents=1,
...
# harvest with self conf properties
